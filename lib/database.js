...
if (/mongo/.test(global.option.database)) {
    Database = class MongoDB {
        constructor(url) {
            ...
            this.connection = this.url || global.option.database
            this.model = {
                database: {},
            }
            this.data = {}
...
} else if (/json/.test(global.option.database)) {
    Database = class Database {
        data = {}
        file = path.join(process.cwd(), "", global.option.database)
